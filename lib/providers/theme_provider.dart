...
final currentSongProvider = Provider<Song?>((final ref) {
...
final currentSongDominantColorProvider = FutureProvider<Color?>((
  final ref,
) async {
  ...
  return coverArtRepo.resolveDominantColor(currentSong);
});
