...
class SettingsManager {
  ...
  final ValueNotifier<bool> useNativeWindowEffectNotifier = ValueNotifier(
    false,
  );
  ...
  Future<void> init() async {
    ...
    useNativeWindowEffectNotifier.value =
        _prefs.getBool('useNativeWindowEffect') ?? false;
    windowOpacityNotifier.value =
        _prefs.getDouble('windowOpacity') ?? _kDefaultWindowOpacity;
    ...
    desktopLyricsEnabledNotifier.value =
        _prefs.getBool('desktopLyricsEnabled') ?? false;
    desktopLyricsFontSizeNotifier.value =
        _prefs.getDouble('desktopLyricsFontSize') ?? 24.0;
    desktopLyricsOpacityNotifier.value =
        _prefs.getDouble('desktopLyricsOpacity') ?? 0.9;
    ...
    crossfadeCurveNotifier.value = _prefs.getInt('crossfadeCurve') ?? 0;
  ...
  Future<void> setBlurLevel(final double level) async {
    ...
    _debouncePersist(
      'blurLevel',
      () => _prefs.setDouble('blurLevel', blurLevelNotifier.value),
    );
  }
  ...
  Future<void> setWindowOpacity(final double opacity) async {
    ...
    _debouncePersist(
      'windowOpacity',
      () => _prefs.setDouble('windowOpacity', windowOpacityNotifier.value),
    );
  }
  ...
  Future<void> setPitchShift(final double pitch) async {
    ...
    _debouncePersist(
      'pitchShift',
      () => _prefs.setDouble('pitchShift', pitchShiftNotifier.value),
    );
  }
  ...
  Future<void> setReverbMix(final double mix) async {
    ...
    _debouncePersist(
      'reverbMix',
      () => _prefs.setDouble('reverbMix', reverbMixNotifier.value),
    );
  }
  ...
  Future<void> setCompressionRatio(final double ratio) async {
    ...
    _debouncePersist(
      'compressionRatio',
      () =>
          _prefs.setDouble('compressionRatio', compressionRatioNotifier.value),
    );
  }
  ...
  Future<void> setReverbRoomSize(final double size) async {
    ...
    _debouncePersist(
      'reverbRoomSize',
      () => _prefs.setDouble('reverbRoomSize', reverbRoomSizeNotifier.value),
    );
  }
  ...
  Future<void> setReverbDamp(final double damp) async {
    ...
    _debouncePersist(
      'reverbDamp',
      () => _prefs.setDouble('reverbDamp', reverbDampNotifier.value),
    );
  }
  ...
  Future<void> setCompThreshold(final double threshold) async {
    ...
    _debouncePersist(
      'compThreshold',
      () => _prefs.setDouble('compThreshold', compThresholdNotifier.value),
    );
  }
  ...
  Future<void> setCompAttack(final double attack) async {
    ...
    _debouncePersist(
      'compAttack',
      () => _prefs.setDouble('compAttack', compAttackNotifier.value),
    );
  }
  ...
  Future<void> setCompRelease(final double release) async {
    ...
    _debouncePersist(
      'compRelease',
      () => _prefs.setDouble('compRelease', compReleaseNotifier.value),
    );
  }
  ...
  Future<void> setCompKneeWidth(final double knee) async {
    ...
    _debouncePersist(
      'compKneeWidth',
      () => _prefs.setDouble('compKneeWidth', compKneeWidthNotifier.value),
    );
  }
  ...
  Future<void> setCompMakeupGain(final double gain) async {
    ...
    _debouncePersist(
      'compMakeupGain',
      () => _prefs.setDouble('compMakeupGain', compMakeupGainNotifier.value),
    );
  }
