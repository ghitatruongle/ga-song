...
class Breakpoints {
  ...
  static bool isMobile(final double width) => width < mobile;

  /// Returns true if width is tablet size.
  static bool isTablet(final double width) =>
      width >= mobile && width < desktop;

  /// Returns true if width is desktop size.
  static bool isDesktop(final double width) => width >= desktop;

  /// Returns true if width is large desktop size.
  static bool isLargeDesktop(final double width) => width >= largeDesktop;

  /// Returns the number of grid columns for the given width.
  static int gridColumns(final double width) {
  ...
  static double horizontalPadding(final double width) {
  ...
  static double contentMaxWidth(final double width) {
