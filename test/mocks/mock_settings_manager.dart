...
class MockSettingsManager implements SettingsManager {
  // ─── Audio Settings ────────────────────────────────────────────────
  @override
  final ValueNotifier<List<double>> eqBandsNotifier = ValueNotifier(List.filled(10, 0.0));
  @override
  ...
  @override
  final ValueNotifier<double> normalizationLevelNotifier = ValueNotifier(-14.0);
  @override
  ...
  @override
  final ValueNotifier<double> lyricsFontSizeNotifier = ValueNotifier(16.0);

  @override
  final ValueNotifier<bool> enableBlurNotifier = ValueNotifier(true);
  @override
  final ValueNotifier<double> blurLevelNotifier = ValueNotifier(0.0);
  @override
  ...
  @override
  final ValueNotifier<double> desktopLyricsFontSizeNotifier = ValueNotifier(0.0);
  @override
  ...
  @override
  final ValueNotifier<Color> customPrimaryColorNotifier = ValueNotifier(const Color(0xFF1DB954));
  @override
  ...
  @override
  final ValueNotifier<Duration?> sleepTimerDurationNotifier = ValueNotifier(null);
  @override
  ...
  @override
  final ValueNotifier<int> sleepTimerFadeOutDurationNotifier = ValueNotifier(30);
  @override
  ...
  // ─── Hotkey Settings ───────────────────────────────────────────────
  @override
  final ValueNotifier<Map<String, String>> customHotkeysNotifier = ValueNotifier({});

  // ─── Window State ──────────────────────────────────────────────────
  @override
  Offset? get savedWindowPosition => const Offset(100, 100);
  @override
  set savedWindowPosition(Offset? value) {}
  @override
  Size? get savedWindowSize => const Size(1000, 700);
  @override
  set savedWindowSize(Size? value) {}
  ...
  Future<void> resetToDefaults() async {
    eqBandsNotifier.value = List.filled(10, 0.0);
